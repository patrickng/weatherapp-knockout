...
define('HourlyEntry',['knockout'], function(ko){
...
define('TenDayEntry',['knockout'], function(ko){
...
define('Location',['knockout', 'HourlyEntry', 'TenDayEntry'], function(ko, HourlyEntry, TenDayEntry){
...
define('DetailedLocationViewModel',['knockout'], function(ko){
...
define('LocationStorage',[],function() {
...
define('AppViewModel',['knockout', 'Location', 'DetailedLocationViewModel', 'LocationStorage'], function(ko, Location, DetailedLocationViewModel, locationStorage) {
...
define('init',['require','jquery','knockout','AppViewModel'],function(require) {
	var $ = require('jquery');
